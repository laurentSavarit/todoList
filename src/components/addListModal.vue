<template>
    <div class="modal" id="addListModal">
        ...
        <div class="modal-card">
            <form action="" method="POST" id="addList" enctype="multipart/form-data" @submit.prevent="postNewList">
                <header class="modal-card-head">
                    <p class="modal-card-title">Ajouter une liste</p>
                    <button class="delete close" type="button" aria-label="close" @click="closeModal"></button>
                </header>
                ...
                <footer class="modal-card-foot">
                    ...
                    <button class="button close" type="button" @click="closeModal">Cancel</button>
                </footer>
            </form>
        </div>
    </div>
